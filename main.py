...
class Admin:
        ...
        if f1.tell() != 0:
            ...
            for student in b_data["students"]:
                if student["sic_no"] == sic_no:
                    print(f"{sic_no} is already registered ")
                    flag = 0
                    break
    ...
    def del_student(self):
        sic_no = int(input("please enter the student Number which you want to deregister :- "))
        flag = 1
        i = 0
    ...
    # here show all info about the books in this module; if it has an error, check letter error:- in books json file data is require
    
    def add_books(self):
        flag = 1
        b_name = input("please enter the book name :- ")
        a_name = input("please enter the author name :- ")
        total_copy = int(input("total copies ? :- "))
...
def add_admin():
    ...
    usr = input("please enter the user name ")
    flag = 0
    while True:
        password = input("enter pswd which has atleast 1[a-z] , 1[A-Z] , 1[0-9] 1[special character] and length between[6-12] ")
...
class Librarian(Admin):
    ...
    def return_book(self):
        print("please enter your sic no:- ")
        sic = int(input())
        ...
        if ch == '1':
            ...
            if check_pswd(usr , pswd):
                ...
                if inp == '1':
                    ...
                    while True:
                        ...
                        print("7. show avialable student")
            ...
            while True:
                ...
                if ch == '1':
                    ...
                    print("invalid input program closed ")
                    break
        elif ch == '3':
            break
        else:
